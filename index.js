...
const student_model_2 = require("./models/student.model");
const student = {
    id: "STU-001",
    name: "Hana Tadesse",
...
console.log((0, student_model_2.parseStudent)({ id: "STU-001", name: "Hana" }));
// Prints a valid Student object 
(0, student_model_2.parseStudent)({ id: 42, name: "Test" });
